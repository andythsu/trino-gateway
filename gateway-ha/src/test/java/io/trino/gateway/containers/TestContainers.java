...
import static io.trino.gateway.containers.ConditionalPullPolicy.TESTCONTAINERS_NEVER_PULL;
...
public final class TestContainers
{
    ...
    public static java.io.Closeable startOrReuse(GenericContainer<?> container)
    {
        boolean reuse = org.testcontainers.utility.TestcontainersConfiguration.getInstance().environmentSupportsReuse();
        ...
        container.withCreateContainerCmdModifier(cmd -> cmd
                .withHostConfig(requireNonNull(cmd.getHostConfig(), "hostConfig is null")
                        .withPortBindings(container.getExposedPorts().stream()
                                .map(exposedPort -> new com.github.dockerjava.api.model.PortBinding(bindPort(exposedPort), new com.github.dockerjava.api.model.ExposedPort(exposedPort)))
    ...
    public static DockerArchitectureInfo getDockerArchitectureInfo(DockerImageName imageName)
    {
        ...
        DockerClient client = org.testcontainers.DockerClientFactory.lazyClient();
    ...
    {
        try {
            client.pullImageCmd(imageName.asCanonicalNameString()).exec(new com.github.dockerjava.api.command.PullImageResultCallback() {
                @Override
    ...
    public record DockerArchitectureInfo(TestContainers.DockerArchitecture hostArch, TestContainers.DockerArchitecture imageArch) {}
    ...
    public enum DockerArchitecture
    {
        ...
        public static TestContainers.DockerArchitecture fromString(String value)
        {
